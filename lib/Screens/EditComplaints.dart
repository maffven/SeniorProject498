...
void main() {
  runApp(EditComplaints());
}
class EditComplaints extends StatefulWidget {
  @override
  final Widget child;
  EditComplaints({Key key, this.child}) : super(key: key);
  EditComplaintsState createState() => EditComplaintsState();
}
...
class EditComplaintsState extends State<EditComplaints> {
  bool _status = true;
